...
public static class PrescriptionTranslator
{
    ...
    public static ObstetricPrescriptionDataDto ObstetricDataToDto(ObstetricPrescriptionData data) => new()
    {
        ...
        MenstrualHistory = ObstetricPrescriptionData.DeserializeSelections(data.MenstrualHistory),
        PastMedicalHistory = ObstetricPrescriptionData.DeserializeSelections(data.PastMedicalHistory),
        FamilyHistory = ObstetricPrescriptionData.DeserializeSelections(data.FamilyHistory),
        PerAbdomen = ObstetricPrescriptionData.DeserializeSelections(data.PerAbdomen),
        PerVaginum = ObstetricPrescriptionData.DeserializeSelections(data.PerVaginum),
        SurgicalHistory = ObstetricPrescriptionData.DeserializeSelections(data.SurgicalHistory),
        PerSpeculum = ObstetricPrescriptionData.DeserializeSelections(data.PerSpeculum),
        Lmp = data.Lmp,
